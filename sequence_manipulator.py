...
output_file = open('C:/Users/phara/Documents/covid_sequence.txt', 'w')
...
with open(file_path,'r') as input_data:
    ...
    for line in input_data:
        temp_DNA = line.strip()
        # the following line to create a variable for the cDNA sequence
        ...
        output_file.write("\n" + comp_RNA)
        output_file.flush()
        #  print lines to see the data line by line
        print(temp_DNA)        
        print(comp_RNA)
        print("===================================================")
